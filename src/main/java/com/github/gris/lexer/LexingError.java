...
/**
 * Represents a lexing error during tokenization.
 */
public class LexingError extends RuntimeException {
    ...
    /**
     * Constructs a LexingError with the specified message, line number, column number, and source line.
     *
     ...
     */
    public LexingError(String message, int line, int col, String sourceLine) {
        super(message);
        this.line = line;
        this.col = col;
    ...
    /**
     * Generates a string representation of the lexical error, including the error message, source line, and pointer.
     *
     * @return A string representing the lexical error.
     */
    @Override
