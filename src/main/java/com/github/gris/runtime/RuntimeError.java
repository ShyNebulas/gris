...
/**
 * Represents a runtime error encountered during parsing.
 */
public class RuntimeError extends RuntimeException {
    ...
    /**
     * Constructs a RuntimeError with the specified message, line number, column number, and source line.
     *
     ...
     */
    public RuntimeError(String message, int line, int col, String sourceLine) {
        super(message);
        this.line = line;
        this.col = col;
    ...
    /**
     * Generates a string representation of the runtime error, including the error message, source line, and pointer.
     *
     * @return A string representing the runtime error.
     */
    @Override
